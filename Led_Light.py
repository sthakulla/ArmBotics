...
for c in cnts2:
	...
	cx = int(M["m10"] / M["m00"])
	cy = int(M["m01"] / M["m00"])
#Green color is used for recyclable
	cv2.circle(frame, (cx, cy), 7, (255, 255, 255), -1)
	cv2.putText(frame, "Recyclable", (cx - 20, cy - 20), cv2.FONT_HERSHEY_SIMPLEX, 2.5, (255, 255, 255), 3)
...
for c in cnts3:
	...
	cx = int(M["m10"] / M["m00"])
	cy = int(M["m01"] / M["m00"])
#Red color is used for not recyclable
	cv2.circle(frame, (cx, cy), 7, (255, 255, 255), -1)
	cv2.putText(frame, "Not recyclable", (cx - 20, cy - 20), cv2.FONT_HERSHEY_SIMPLEX, 2.5, (255, 255, 255), 3)
